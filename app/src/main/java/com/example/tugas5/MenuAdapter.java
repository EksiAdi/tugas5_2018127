...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MakananViewHolder> {
    ...
    @NonNull
    @Override
    public MenuAdapter.MakananViewHolder
    ...
    @Override
    public void onBindViewHolder(@NonNull MenuAdapter.MakananViewHolder holder, int position) {
